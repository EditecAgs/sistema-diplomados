<section class="relative w-full min-h-screen bg-[#1a0510] flex flex-col items-center justify-center overflow-hidden px-6 pt-24 pb-16">
    ...
    <div class="relative z-10 text-center max-w-2xl">
        ...
        <h1 class="text-4xl md:text-6xl font-semibold text-white leading-tight tracking-tight mb-4">
            Diplomado en<br>
            <span class="text-rose-300">Semiconductores</span>
        </h1>
        <p class="text-gray-200 text-base mb-10 leading-relaxed">
            Formación especializada en diseño, fabricación y aplicación<br class="hidden md:block"> de dispositivos semiconductores
        </p>
        ...
        <div class="flex flex-wrap gap-3 justify-center">
            ...
            <a href="" class="inline-flex items-center gap-2 text-rose-300 border border-rose-300/30 hover:border-rose-300/60 hover:bg-rose-300/7 font-medium text-sm px-6 py-3 rounded-lg transition-all duration-200 hover:-translate-y-0.5">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
    ...
    <div class="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2">
        <span class="text-[10px] tracking-[2px] uppercase text-gray-200">Scroll para más información</span>
        <svg class="w-4 h-4 text-rose-300/60 animate-bounce" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
