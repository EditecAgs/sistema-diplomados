<div id="modal-overlay"
  ...
  <div class="bg-white rounded-2xl w-full max-w-lg max-h-[85vh] overflow-hidden flex flex-col">
    ...
    <div class="h-40 bg-[#1a0510] shrink-0 relative" id="modal-img">
      <img id="modal-img-photo" src="" alt=""
    ...
    <div class="px-6 pt-5 shrink-0">
      ...
      <p class="text-[13px] text-[#8b4060]" id="modal-sub"></p>
    </div>

    {{-- Cuerpo scrolleable — todo en un solo div --}}
    <div class="px-6 pb-6 pt-4 overflow-y-auto flex-1 flex flex-col gap-5">

      {{-- Descripción --}}
      <div>
        <p class="text-[11px] font-semibold tracking-[1.5px] uppercase text-[#8b4060] mb-2">
          Propósito del módulo
        </p>
        <p id="modal-description" class="text-[13.5px] text-[#3d1020] leading-relaxed"></p>
      </div>
